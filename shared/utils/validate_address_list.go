...
// Snapshot from 11/20/2025
var OFACAddressMap = map[string]struct{}{
	"0x04dba1194ee10112fe6c3207c0687def0e78bacf":  {},
	"0x08723392ed15743cc38513c4925f5e6be5c17243":  {},
	"0x08b2efdcd8822efe5ad0eae55517cf5dc544251":   {},
	...
	"0xdcbefbfeccce100cce9e4b153c4e15cb885643193": {},
...
func ValidateNoOFACAddress(addressList []string) error {
	for _, address := range addressList {
		if _, ok := OFACAddressMap[address]; ok {
			return status.Errorf(codes.InvalidArgument, "Address %s is in the OFAC Sanctioned Digital Currency Addresses list", address)
		}
	}
