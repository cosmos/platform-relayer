...
func (processor CheckRecvPacketDeliveryProcessor) Process(ctx context.Context, transfer *EurekaTransfer) (*EurekaTransfer, error) {
...
// this stage
func (processor CheckRecvPacketDeliveryProcessor) Cancel(transfer *EurekaTransfer, err error) {
...
func (processor CheckRecvPacketDeliveryProcessor) ShouldProcess(transfer *EurekaTransfer) bool {
...
func (processor CheckRecvPacketDeliveryProcessor) State() db.EurekaRelayStatus {
	return db.EurekaRelayStatusCHECKRECVPACKETDELIVERY
}
