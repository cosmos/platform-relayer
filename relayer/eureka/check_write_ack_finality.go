...
func (processor CheckWriteAckFinalityProcessor) Process(ctx context.Context, transfer *EurekaTransfer) (*EurekaTransfer, error) {
...
func (processor CheckWriteAckFinalityProcessor) Cancel(transfer *EurekaTransfer, err error) {
...
func (processor CheckWriteAckFinalityProcessor) ShouldProcess(transfer *EurekaTransfer) bool {
...
func (processor CheckWriteAckFinalityProcessor) State() db.EurekaRelayStatus {
	return db.EurekaRelayStatusAWAITINGWRITEACKFINALITY
}
