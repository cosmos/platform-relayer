...
func (processor BatchRecvPacketProcessor) Process(ctx context.Context, transfers []*EurekaTransfer) ([]*EurekaTransfer, error) {
...
func (processor BatchRecvPacketProcessor) Cancel(transfers []*EurekaTransfer, err error) {
...
func (processor BatchRecvPacketProcessor) ShouldProcess(transfer *EurekaTransfer) bool {
...
func (processor BatchRecvPacketProcessor) State() db.EurekaRelayStatus {
