...
func (processor RetryAckPacketProcessor) Process(ctx context.Context, transfer *EurekaTransfer) (*EurekaTransfer, error) {
	...
	transfer.RecordTransactionRetried(ctx, metrics.EurekaRecvToAckRelayType)
...
func (processor RetryAckPacketProcessor) Cancel(transfer *EurekaTransfer, err error) {
...
func (processor RetryAckPacketProcessor) ShouldProcess(transfer *EurekaTransfer) bool {
...
func (processor RetryAckPacketProcessor) State() db.EurekaRelayStatus {
