...
func (c *signerServiceClient) GetChains(ctx context.Context, in *GetChainsRequest, opts ...grpc.CallOption) (*GetChainsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/signerservice.SignerService/GetChains", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *signerServiceClient) GetWallet(ctx context.Context, in *GetWalletRequest, opts ...grpc.CallOption) (*GetWalletResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/signerservice.SignerService/GetWallet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *signerServiceClient) GetWallets(ctx context.Context, in *GetWalletsRequest, opts ...grpc.CallOption) (*GetWalletsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/signerservice.SignerService/GetWallets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *signerServiceClient) Sign(ctx context.Context, in *SignRequest, opts ...grpc.CallOption) (*SignResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/signerservice.SignerService/Sign", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SignerService_GetChains_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/signerservice.SignerService/GetChains",
	}
...
func _SignerService_GetWallet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/signerservice.SignerService/GetWallet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SignerService_GetWallets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/signerservice.SignerService/GetWallets",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SignerService_Sign_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/signerservice.SignerService/Sign",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
